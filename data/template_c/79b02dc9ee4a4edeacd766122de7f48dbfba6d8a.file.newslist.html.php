<?php /* Smarty version Smarty-3.1.16, created on 2017-05-28 14:44:02
         compiled from "tpl\admin\newslist.html" */ ?>
<?php /*%%SmartyHeaderCode:18409591011f1171155-90847472%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '18409591011f1171155-90847472',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_591011f128c173_64400029',
  'variables' => 
  array (
    'data' => 0,
    'value' => 0,
...
<?php if ($_valid && !is_callable('content_591011f128c173_64400029')) {function content_591011f128c173_64400029($_smarty_tpl) {?><!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
	<title>后台管理系统</title>
    ...
    <script type="text/javascript">
	    ...
	    function is_del(num){
	    	if (confirm('确定要删除?')===true) {
	    		// document.write('index.php?controller=admin&method=newsdel&id='+num);
	    		window.location.href='index.php?controller=admin&method=newsdel&id='+num;
	    	};
	    }
	</script>
...
'"><input type="image" src="img/images/icn_trash.png" title="Trash" onclick="is_del(<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
)"></td>
						</tr>
					<?php }
